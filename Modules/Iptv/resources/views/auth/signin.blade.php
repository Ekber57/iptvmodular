                  ...
                  <div class="">
                   ...
                   <form action="/signin" method="POST">
                     ...
                     <div class="form-group tx-left">
                        ...
                        <input name="username" type="text" class="form-control" placeholder="email@domain.com">
                     </div>
                     ...
                     <button class="btn btn-brand btn-block">Sign In</button>
                     ...
                     <div class="tx-13 mg-t-20 tx-center tx-gray-500"> <a href="/signup" class="tx-dark tx-semibold">{{ __('messages.create_an_account_for_signin_view') }}</a></div>
                  </div>
               </div>
            </div>
         </div>
