        ...
        <div class="card mg-b-30">
            ...
            <form id="sl" action="/reseller/create" method="POST">
                ...
                <div class="row mg-t-20">
                    <div class="col-lg">
                        <input name="name" oninput="createUsername(this.value)" class="form-control form-control-sm"
                            placeholder=" {{ __('messages.name') }}" type="text">
                    </div>
                    <div class="col-lg">
                        <input readonly id='username' value="" name="username" class="form-control form-control-sm"
                            placeholder=" {{ __('messages.username') }}" type="text">
                    </div>
                    <!-- col -->
                    <div class="col-lg mg-t-10 mg-lg-t-0">
                        <input name="phone" class="form-control form-control-sm" placeholder=" {{ __('messages.phone') }}"
                            type="text">
                    </div>
                ...
                <div class="row mg-t-20">
                    <div class="col-lg">
                        <input name="mail" class="form-control form-control-sm" placeholder=" {{ __('messages.mail') }}"
                            type="text">
                    </div>
                    <div class="col-lg">
